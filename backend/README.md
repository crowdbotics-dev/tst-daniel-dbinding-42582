...
## Project Structure
    ...
    ├── tst_daniel_dbinding_42582  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_dbinding_42582`
...
2. Clone this repo and `cd tst_daniel_dbinding_42582`
